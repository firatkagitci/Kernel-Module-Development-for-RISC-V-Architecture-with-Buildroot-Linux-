...
Add the user program to the `buildroot/overlay/home` directory, after that, we need to cross-compile this c code according to our target system. The cross-compilation command is given below:
